...
class Bill_App:
    def __init__(self, root):
        ...
        self.root.title("Personel Sağlık Taraması Takip Formu")
        bg_color = "#badc57"
        title = Label(self.root, text="Personel Sağlık Taraması Takip Formu", font=('times new roman', 30, 'bold'), pady=2, bd=12, bg="#badc57", fg="Black", relief=GROOVE)
        title.pack(fill=X)
    # ================variables=======================
    ...
    # =============customer retail details======================
        F1 = LabelFrame(self.root, text="Personel Bilgileri", font=('times new roman', 15, 'bold'), bd=10, fg="Black", bg="#badc57")
        F1.place(x=0, y=80, relwidth=1)

        cname_lbl = Label(F1, text="İsim:", bg=bg_color, font=('times new roman', 15, 'bold'))
        cname_lbl.grid(row=0, column=0, padx=20, pady=5)
        cname_txt = Entry(F1, width=15, textvariable=self.c_name, font='arial 15', bd=7, relief=GROOVE)
        cname_txt.grid(row=0, column=1, pady=5, padx=10)

        cphn_lbl = Label(F1, text="Tel:", bg="#badc57", font=('times new roman', 15, 'bold'))
        ...
        c_bill_lbl = Label(F1, text="Personel No:", bg="#badc57", font=('times new roman', 15, 'bold'))
